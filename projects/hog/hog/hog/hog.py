...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return player_score<opponent_score and opponent_score-player_score<3 and player_score!=0
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==1:
            ...
            if DEBUG:
                print('DEBUG:current_score1 is:',score1 )
            ...
            say=say(score0,score1)
            if DEBUG:
                print('DEBUG:current_score0 is:',score0 )
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def conmentary(current_score0,current_score1):
        if who:
            if current_score1-last_score>running_high:
                print(current_score1-last_score,"point(s)! The most yet for Player 1")
                return announce_highest(who,current_score1,current_score1-last_score)
            else:
                return  announce_highest(who,current_score1,running_high)
        else:
            if current_score0-last_score>running_high:
                print(current_score0-last_score,'point(s)! The most yet for Player 0')
                return announce_highest(who,current_score0,current_score0-last_score)
            else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    maxn_num=1
    while (try_num<=10):
        temp=averaged_dice(try_num,dice)
        if maxn<temp:
            maxn=temp
            maxn_num=try_num
        try_num+=1
